...
DROP TABLE IF EXISTS [cdw_cache_staging].[{project_schema}].[image_epic];
CREATE TABLE [cdw_cache_staging].[{project_schema}].[image_epic] (
    image_epic_index        int             identity(1,1) primary key,
...
WHERE
    ...
    and case
        ...
        end between @date_start and @date_stop
