...
/*
DROP TABLE IF EXISTS [cdw_cache_staging].[{project_schema}].[ss_obs_epic];
CREATE TABLE [cdw_cache_staging].[{project_schema}].[ss_obs_epic] (
    flowsheet_row_key   int             not null primary key,
    name                varchar(250)    not null,
    obs_category        varchar(100)    not null,
);

INSERT INTO {project_schema}.ss_obs_epic
VALUES
