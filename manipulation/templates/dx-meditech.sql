...
declare @date_stop    date = '2023-06-02';   -- hard ceiling; Meditech data ends here


DROP TABLE IF EXISTS [cdw_cache_staging].[{project_schema}].[dx_meditech];
CREATE TABLE [cdw_cache_staging].[{project_schema}].[dx_meditech] (
    dx_meditech_index       int             identity(1,1) primary key,
...
WHERE
    d.visit_start_date between @date_start and @date_stop
