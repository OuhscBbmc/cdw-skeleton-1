...
DROP TABLE IF EXISTS [cdw_cache_staging].[{project_schema}].[invoice_gecb];
CREATE TABLE [cdw_cache_staging].[{project_schema}].[invoice_gecb] (
    invoice_gecb_index  int             identity(1,1) primary key,
...
INSERT INTO {project_schema}.invoice_gecb
SELECT
    i.mrn_gecb
    ,pt.mrn_mpi
    ,i.invpk
