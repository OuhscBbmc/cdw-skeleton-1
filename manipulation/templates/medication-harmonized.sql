...
DROP TABLE IF EXISTS [cdw_cache_staging].[{project_schema}].[medication];
CREATE TABLE [cdw_cache_staging].[{project_schema}].[medication] (
...
INSERT INTO {project_schema}.medication
SELECT
    'meditech'
    ,m.account_number
    ,null
...
WHERE m.admin_datetime between @date_start and '2023-06-02'
...
WHERE m.start_date between '2023-06-03' and @date_stop
;
