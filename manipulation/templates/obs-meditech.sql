...
DROP TABLE IF EXISTS [cdw_cache_staging].[{project_schema}].[obs_meditech];
CREATE TABLE [cdw_cache_staging].[{project_schema}].[obs_meditech] (
    obs_meditech_index      int             identity(1,1) primary key,
...
WHERE
    o.obs_datetime between @date_start and @date_stop
