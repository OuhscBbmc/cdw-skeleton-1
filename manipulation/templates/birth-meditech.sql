...
DROP TABLE IF EXISTS [cdw_cache_staging].[{project_schema}].[birth_meditech];
CREATE TABLE [cdw_cache_staging].[{project_schema}].[birth_meditech] (
...
WHERE b.birth_date between @date_start and @date_stop
